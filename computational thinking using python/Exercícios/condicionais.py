...
if idade_usuario > idade_colega:
    ...
    print("A idade do usuário represnta {:.1f} % da idade do {}." .format(porcentagem, nome_colega))

else:
    idade_colega > idade_usuario
    porcentagem = idade_colega / idade_usuario * 100
    print("A idade do colega represnta {:.1f} % da idade do {}.".format(porcentagem, nome_usuario))
